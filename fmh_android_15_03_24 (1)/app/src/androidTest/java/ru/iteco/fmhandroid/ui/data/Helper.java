...
public class Helper {
    ...
    public static AuthInfo emptyAll() {
        String pass = "";
        String login = "";
        return new AuthInfo(login, pass);
    }

    public static AuthInfo exchangeLoginPassword() {
        String pass = "login2";
        String login = "password2";
        return new AuthInfo(login, pass);
    }
    public static AuthInfo specialCharactersLoginPassword() {
        String pass = "password2$";
        String login = "@login2";
        return new AuthInfo(login, pass);
    }
    public static AuthInfo differentLetterCase() {
        String pass = "pASSword2";
        String login = "lOgIN2";
        return new AuthInfo(login, pass);
    }
