...
Кейсы для ручного тестирования и для авто-тестов будут дублировать друг друга и охватывать весь базовый приложения: базовые функции по работе с новостями, переходы по разделам приложения, авторизацмя в приложении, работа с цитатами и разделом "О нас". Так как в конце работы необходимо сравнить результаты по времязатратам ручного тестирования и авто-тесов, набор кейс должен быть примерно одинаковым. 
